...
export class HomeComponent implements AfterViewInit {
    ...
    @ViewChild('storeDialog')
    public storeDialog: DialogComponent;
    ...
    public storeButtons: Object[] = this.getDialogButtons('store');
    public loadButtons: Object[] = this.getDialogButtons('load');
    ...
    public ngAfterViewInit(): void {
        ...
        console.log('Generating diagram in home ngAfterViewInit')
        this.generateDiagram();
        console.log('After Generating diagram in home ngAfterViewInit')
        console.log('Adding newpage in home ngAfterViewInit')
        this.page.addNewPage();
        console.log('After adding newpage in home ngAfterViewInit')
    ...
    public getDialogButtons(dialogType: string): Object[] {
        ...
        switch (dialogType) {
            ...
            case 'store':
                buttons.push({
                    click: this.btnStore.bind(this), buttonModel: { content: 'Store', cssClass: 'e-flat e-db-primary', isPrimary: true }
                });
                break;
            case 'load':
                buttons.push({
                    click: this.btnStore.bind(this), buttonModel: { content: 'Load', cssClass: 'e-flat e-db-primary', isPrimary: true }
                });
                break;
            case 'tooltip':
                buttons.push({
    ...
    private btnStore(): void {
        CommonKeyboardCommands.download(this.page.savePage(), (document.getElementById('storeName') as HTMLInputElement).value);
        this.storeDialog.hide();
    }
    ...
    public menuClick(args: MenuEventArgs): void {
        ...
        switch (commandType.toLowerCase()) {
            ...
            case 'open':
                ...
                break;
            case 'load':
                CommonKeyboardCommands.openDbloadBox(true, '.json');
                break;
            case 'save':
            ...
            case 'saveas':
                ...
                break;
            case 'store':
                (document.getElementById('storeName') as HTMLInputElement).value = document.getElementById('diagramName').innerHTML;
